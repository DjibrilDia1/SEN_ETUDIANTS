        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content shadow-lg rounded-4">
                ...
                <div class="modal-body p-4">
                    <form action="etudiantMainController" method="POST"  enctype="multipart/form-data" id="formAjoutEtudiant">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control rounded-3" id="adresse" name="adresse" required>
                            </div>
                        </div>
                        <div class="modal-footer bg-light border-top-0">
                            <button type="reset" class="btn btn-secondary rounded-3">Annuler</button>
                            <button type="submit" class="btn btn-primary rounded-3"
                                form="formAjoutEtudiant">Enregistrer</button>
                        </div>
                    </form>
                </div>
            </div>
